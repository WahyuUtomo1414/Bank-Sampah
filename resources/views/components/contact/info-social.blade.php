        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div class="space-y-8">
                <x-common.section-header
                    ...
                    description="Pilih cara yang paling nyaman bagi Anda untuk berkomunikasi dengan kami. Kami siap melayani setiap hari kerja."
                />
                ...
                <div class="panel p-8">
                    ...
                    <div class="mt-6 flex items-center gap-3 border-t border-[var(--color-outline-variant)] pt-6">
                        <svg class="size-5 text-[var(--color-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        <p class="text-sm font-bold text-[var(--color-ink)]">{{ $contactInfo['hours'] }}</p>
                    </div>
                </div>
            </div>
